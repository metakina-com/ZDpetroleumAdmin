<template>
  <div class="user">
    <el-row :gutter="20" v-if="show">
      <el-col :span="10" :xs="24" style="margin-bottom: 5px">
        <div class="grid-content bg-purple">
          <h3>总盈亏 {{ sumData.todayTradeCount }}</h3>
    ...
    <el-table :data="list" border tooltip-effect="dark" style="width: 100%">
      ...
      ></el-table-column> -->
      <el-table-column prop="pairsName" label="交易对" min-width="110" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="type" label="方向" min-width="50" align="center" show-overflow-tooltip>
      ...
      <el-table-column prop="closePrice" label="交割价格" min-width="90" align="center" show-overflow-tooltip>
      </el-table-column>

      
      <el-table-column prop="count" label="交割数量" min-width="90" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="profit" label="盈亏(USDT)" min-width="110" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="closeTime" label="交割时间" min-width="150" align="center" show-overflow-tooltip>
      </el-table-column>
...
export default {
  ...
  methods: {
    getList() {
      ...
      // 获取交割历史
      this.$http
        .get("/admin/sysAdmin/getMicContractHistory", this.listQuery)
        .then((res) => {
