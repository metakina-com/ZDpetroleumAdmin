<template>
  <div class="user">
    ...
    <div class="filter-container" style="padding-bottom: 30px">
      <span class="" style="margin: 0px 10px 0px 10px">邮箱</span>
    ...
    <el-table :data="list" border tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column prop="" label="委托类型" min-width="70" align="center" show-overflow-tooltip><template
          slot-scope="scop">
          <p v-if="scop.row.tradeType == 'OPEN_UP'">
            开多
          </p>
      ...
      <el-table-column prop="isContractHands" label="委托张数" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="price" label="委托价" min-width="70" align="center" show-overflow-tooltip>
      </el-table-column>
      <!-- <el-table-column
        prop=""
        label="委托价值"
    ...
    <el-table-column prop="margin" label="保证金" min-width="70" align="center">
      </el-table-column>

      <el-table-column prop="takeFee" label="手续费" min-width="70" align="center">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        this.$http
          .get("/admin/sysAdmin/getEntrustOrders", this.listQuery)
          .then((res) => {
